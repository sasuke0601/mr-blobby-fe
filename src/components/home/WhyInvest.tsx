    ...
    <div className="w-full py-[120px] lg:py-40 bg-dark">
      ...
      >
        ...
        <p className="font-primary text-[16px] lg:text-[20px] font-semibold  mt-[40px] lg:mt-[60px]">
          ...
          figure covered in yellow spots, with a permanent toothy grin and green
          jiggling eyes. Mr Blobby communicates only by saying the word "blobby"
          in an electronically altered voice, expressing his moods through tone
          of voice and repetition. He topped the UK Singles Chart with the 1993
          Christmas release "Mr Blobby".
          <br />
          <br />
