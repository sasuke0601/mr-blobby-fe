...
function Whitepaper() {
  return (
    <main>
      <Header />
      <div className="min-h-full bg-[#202020] w-full pb-10">
        <div
        ...
        <div className="relative w-full pt-20 bg-dark">
          <div className=" md:max-w-[760px] mx-6 lg:mx-auto mt-5 pb-[60px] relative">
            ...
            <p className="text-primary font-semibold text-[16px] sm:text-[18px]">
              ...
              <br />
              <br />
              <span className="font-bold text-[20px]">Mission and Vision</span>
              <br />
              The project's primary goal is to create a community of like-minded
              individuals who are excited about the BSC network and enjoy using
              it in a fun and engaging way. Our mission is to offer a safe and
              rewarding BSC experience by building various utilities on the BSC
              network, such as Blobbyscan, Blobby Token-2023 Standard
              decentralized exchange, and the Blobby Blobby game. Our vision is
              to make Blobby the go-to project for the BSC community and beyond
              by creating an ecosystem that rewards early investors and loyal
              community members.
              <br />
              <br />
              <span className="font-bold text-[20px]">Tokenomics</span>
              The total supply of BLOBBY is 14,000,000 with 5% reserved for the
              development team, 5% for the marketing team, and 90% for the
              community. The team is committed to transparency and will provide
              regular updates on the use of the reserved tokens.
              <br />
              <br />
              <span className="font-bold text-[20px]">Games</span>
              <br />
              Blobby.IO and Blobby World are two games that will be built on the
              Binance blockchain. Both games will be Play-to-Earn, meaning that
              players will be able to connect their wallets and earn BLOBBY
              tokens as they play. The games will be launched on the Appstore
              and Desktop.
              <br />
              <br />
              <span className="font-bold text-[20px]">Team</span>
              <br />
              The team behind Blobby is focused on building various utilities on
              the BSC network, such as Blobbyscan, Blobby Token-2023 Standard
              decentralized exchange as well as games like "Blobby Blobby". The
              team is composed of six early investors who will be the backbone
              of the project. The team is committed to building the project from
              the ground up together and is focused on creating a community of
